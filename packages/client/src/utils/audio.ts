 ...
 * From https://github.com/xai-cookbook/blob/main/voice-agent-examples/webrtc/client/src/utils/audio.ts
 */
 ...
 */
export function resampleTo24kHz(audioBuffer: AudioBuffer, targetSampleRate: number = SAMPLE_RATE): Float32Array {
